...
class Course(models.Model):
    ...
    preview = models.ImageField(upload_to='materials/', verbose_name='Превью', null=True, blank=True, help_text='Загрузите картинку')
...
class Lesson(models.Model):
    ...
    link_to_the_video = models.CharField(max_length=300, verbose_name='Ссылка на видео', blank=True, null=True, help_text='Вставте ссылку на видео')
    course = models.ForeignKey(Course, verbose_name='Курс', on_delete=models.SET_NULL, help_text='Выберите курс', null=True, blank=True)
